...
export interface ChatUpdatePayload {
  ...
  type: 'created' | 'newMessage' | 'newParticipant' | 'newViewer';
}
 ...
 */
export interface NotifUpdatePayload {
  notification: DatabaseNotification;
}

/**
 * Interface representing the payload for a notification create event, which contains:
 * - `notification`: The updated notification object.
 */
export interface NotifCreatePayload {
  notification: DatabaseNotification;
}

/**
 * Interface representing the payload for a notification remove event, which contains:
 * - `notification`: The updated notification object.
 */
export interface NotifRemovePayload {
  notification: DatabaseNotification;
}
...
export interface ClientToServerEvents {
  ...
  joinChat: (chatID: string?, username: string) => void;
...
export interface ServerToClientEvents {
  ...
  notificationUpdate: (notif: NotifUpdatePayload) => void;
  notificationCreate: (notif: NotifCreatePayload) => void;
  notificationRemove: (notif: NotifRemovePayload) => void;
}
