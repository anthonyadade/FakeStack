 ...
 * - `readBy`: The users who have read the message.
 */
...
/**
 * Express request for adding a message to a chat.
 * - `body`: Contains the `messageToAdd` object and `username`, which includes the message text and metadata (excluding `type`).
 */
