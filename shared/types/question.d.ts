 ...
 * - `subscriptions`: An array of subscriptions to the question.
 */
 ...
 * - `subscriptions`: An array of ObjectIds referencing subscriptions associated with the question.
 */
export interface DatabaseQuestion
  extends Omit<Question, 'tags' | 'answers' | 'comments' | 'subscriptions'> {
  _id: ObjectId;
  tags: ObjectId[];
  answers: ObjectId[];
  comments: ObjectId[];
 ...
 * - `subscriptions`: An array of populated `DatabaseSubscription` objects.
 */
export interface PopulatedDatabaseQuestion
  extends Omit<DatabaseQuestion, 'tags' | 'answers' | 'comments' | 'subscriptions'> {
  tags: DatabaseTag[];
